...
import yapp.devcamp.fallInIdol.dao.ChatsDao;
import yapp.devcamp.fallInIdol.model.User;
import yapp.devcamp.fallInIdol.dao.UserDao;
import yapp.devcamp.fallInIdol.service.RandomNameService;
	...
	public ModelAndView twitterResponse(HttpServletRequest request,HttpServletResponse response,
	  ...
	  @RequestMapping(value = "/create-user", method = RequestMethod.POST)
	   ...
	   public ModelAndView feedResponse(HttpServletRequest request,HttpServletResponse response,
	         @RequestParam("choice") String choice,@RequestParam("language") String lang,
