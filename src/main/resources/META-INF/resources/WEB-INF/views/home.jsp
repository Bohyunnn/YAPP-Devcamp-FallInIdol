	...
	<div class="w3-top">
		<div class="w3-row w3-large w3-light-grey">
			<a
				...
				w3-hover-white"
				title="photo">PHOTO</a> <a href="#twitter"
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white"
				title="photo">PHOTO</a> <a
				href="${pageContext.request.contextPath}/twit">>>>>>> devcam2
				class="w3-bar-item w3-button w3-hide-small w3-padding-large
				w3-hover-white" title="twitter">TWITTER</a> <a href="#"
			...
			<div class="w3-row">
				<div class="w3-quarter">
					<c:forEach items="${result}" var="item" varStatus="status"
						begin="0" end="25">
						<img src="${item}" style="max-width: 100%; width: 600px;"
